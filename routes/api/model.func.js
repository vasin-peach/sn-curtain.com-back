  ...
  async updateModel(data) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!data || isEmpty(data))
        return reject('bad param, object `data` is empty.')
      if (!data.query || isEmpty(data.query))
        return reject('bad param, object `data.query` is empty.')
      if (!data.data || isEmpty(data.data))
        return reject('bad param, object `data.data` is empty.')
      if (!data.document)
        return reject('bad param, string `data.document` is empty.')
